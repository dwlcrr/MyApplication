...
package com.loveplusplus.update.view.wheel;
...
import cn.smm.smmlib.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xbbffffff, 0x33ffffff };
