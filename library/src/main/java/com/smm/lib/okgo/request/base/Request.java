 ...
 */
package com.smm.lib.okgo.request.base;

import android.text.TextUtils;
import com.smm.lib.okgo.OkGo;
import com.smm.lib.okgo.adapter.AdapterParam;
import com.smm.lib.okgo.adapter.CacheCall;
import com.smm.lib.okgo.adapter.Call;
import com.smm.lib.okgo.adapter.CallAdapter;
import com.smm.lib.okgo.cache.CacheEntity;
import com.smm.lib.okgo.cache.CacheMode;
import com.smm.lib.okgo.cache.policy.CachePolicy;
import com.smm.lib.okgo.callback.Callback;
import com.smm.lib.okgo.convert.Converter;
import com.smm.lib.okgo.model.HttpHeaders;
import com.smm.lib.okgo.model.HttpMethod;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public Converter<T> getConverter() {
        ...
        if (converter == null) converter = (Converter<T>) callback;
