...
public class SimpleHUD {
    ...
    public static final int DISMISS_DELAY_SHORT = 1000;
    public static final int DISMISS_DELAY_MIDIUM = 3000;
    public static final int DISMISS_DELAY_LONG = 4000;
    ...
    public static void showLoadingMessage(Context context, String msg, boolean cancelable) {
        dismiss();
        setDialog(context, msg, R.mipmap.icon_simplehud_loading, cancelable);
    ...
    public static void showErrorMessage(Context context, String msg) {
        dismiss();
        setDialog(context, msg,R.mipmap.icon_simplehud_error, true);
        if (dialog != null) {
            dialog.show();
            dismissAfterSeconds();
        }
    ...
    public static void showSuccessMessage(Context context, String msg) {
        dismiss();
        setDialog(context, msg, R.mipmap.icon_simplehud_success, true);
        if (dialog != null) {
            dialog.show();
            dismissAfterSeconds();
        }
    ...
    public static void showInfoMessage(Context context, String msg) {
        dismiss();
        setDialog(context, msg, R.mipmap.icon_simplehud_info, true);
        if (dialog != null) {
            dialog.show();
            dismissAfterSeconds();
        }
