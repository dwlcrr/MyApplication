 ...
 */
package com.example.test.net.callback;

import com.example.test.entity.base.LzyResponse;
import com.example.test.entity.base.SimpleResponse;
import com.example.test.utils.other.Convert;
