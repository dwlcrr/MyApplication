...
public class DropDownMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_dropdown);
    ...
    private void initView() {
        ...
        mMenuAdapter1 = new MenuListAdapter(this, Arrays.asList(citys));
        mMenuAdapter2 = new MenuListAdapter(this, Arrays.asList(ages));
        mMenuAdapter3 = new MenuListAdapter(this, Arrays.asList(sexs));
