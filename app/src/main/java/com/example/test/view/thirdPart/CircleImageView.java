...
public class CircleImageView extends AppCompatImageView {
    ...
    public static void setDEFAULT_BORDER_WIDTH(int dEFAULT_BORDER_WIDTH) {
		DEFAULT_BORDER_WIDTH = dEFAULT_BORDER_WIDTH;
	}

	private void init() {
//    	DEFAULT_BORDER_WIDTH = context.getResources().getDimensionPixelOffset(R.dimen.y2);
        super.setScaleType(SCALE_TYPE);
        mReady = true;

        bitmapQiye = BitmapFactory.decodeResource(context.getResources(), R.mipmap.qiye);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2,
                    (float) ((3 + Math.cos((double) (Math.PI * 5 / 18)))
...
//            Paint p = new Paint();
//            p.setAntiAlias(true);
//            float ww = getMeasuredWidth();
//            float w = ww / 3.5f;
//            Rect r = new Rect(0,0,(int)w,(int)w);
////            RectF ef = new RectF(ww - w*1.3f,ww - w*1.3f,ww-w*0.3f,ww-w*0.3f);
//            RectF ef = new RectF(0,0,bitmapQiye.getWidth()/2,bitmapQiye.getWidth()/2);
//            Logger.info("画bitmap  有没有出现那 " + ww + "   " + w);
//            canvas.drawBitmap(bitmapQiye,r,ef,p);
//        }
